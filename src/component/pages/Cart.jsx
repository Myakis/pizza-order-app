...
import { clearCart, clearPizza, minusPizza, plusPizza } from '../../redux/reducer/cart-reducer';
...
function Cart() {
  ...
  const removeGroupPizza = id => {
    dispatch(clearPizza(id));
  };
          ...
          <div className='cart'>
            <div className='cart__top'>
              ...
              <div className='cart__clear'>
                ...
                <span onClick={clearFullCart}>Очистить корзину</span>
              </div>
            </div>
